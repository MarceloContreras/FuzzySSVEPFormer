...
#     poetry run python src/experiment_time.py --time $t --sub $1 --model ssvepformer --dataset NAKANISHI --seed s
#     poetry run python src/experiment_time.py --time $t --sub $1 --model f1ssvepformer_C --dataset NAKANISHI --seed s
#     poetry run python src/experiment_time.py --time $t --sub $1 --model f2ssvepformer_C --dataset NAKANISHI --seed s
# done