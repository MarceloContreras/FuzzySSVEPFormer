...
def get_args_parser():
    ...
    parser.add_argument(
        "--dataset_path",
        default="/home/marcelo/Documents/Tesis/FuzzySSVEPFormer/datasets/2015_Nakanishi_SSVEP_database",
        type=str,
        help="dataset path",
    )
    parser.add_argument(
...
def main(args):
    ...
    num_subjects = 10
    # Creata results file
    filename = os.path.join(args.output_dir, f"TRCA_Nakanishi.csv")
